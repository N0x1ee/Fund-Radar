...
def home():
    """Full multi-page FundRadar web app (landing, dashboard, explorers, etc.)."""
    return _APP_HTML


@app.get("/legacy", response_class=HTMLResponse, tags=["meta"])
def legacy_dashboard():
    """Original single-page dashboard (kept for reference)."""
    return _DASHBOARD
